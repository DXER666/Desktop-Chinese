...
export class PublishRepositoryInternal extends React.Component<
  IPublishRepositoryProps & WithTranslation,
  ...
  public render() {
    return (
      <DialogContent>
        ...
        <Row>
          <TextBox
            label={this.props.t('publishRepository.nameLabel')}
            value={this.name}
        ...
        <Row>
          <TextBox
            label={this.props.t('publishRepository.descriptionLabel')}
        ...
        <Row>
          <label>
            ...
            />
            {this.props.t('publishRepository.keepThisCodePrivate')}
          </label>
        </Row>
  ...
  private renderSanitizedName() {
    ...
    return (
      <Row className="warning-helper-text">
        ...
        {this.props.t('publishRepository.willBeCreatedAs', {
          name: sanitizedName,
        })}
      </Row>
    )
...
export const PublishRepository = withTranslation()(
  PublishRepositoryInternal
) as unknown as React.ComponentClass<IPublishRepositoryProps>
