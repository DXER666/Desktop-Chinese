 ...
 */
export class PublishInternal extends React.Component<
  IPublishProps & WithTranslation,
  IPublishState
> {
  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={
          __DARWIN__
            ? this.props.t('publishRepository.titleDarwin')
            : this.props.t('publishRepository.titleOther')
        }
      ...
      >
        ...
        >
          <span id="dotcom-tab">
            {this.props.t('publishRepository.tabDotcom')}
          </span>
          <span id="enterprise-tab">
            {this.props.t('publishRepository.tabEnterprise')}
          </span>
        </TabBar>
  ...
  private renderSignInTab(tab: PublishTab) {
    const signInTitle = this.props.t('publishRepository.signInButton')
    switch (tab) {
      case PublishTab.DotCom:
        return (
          <CallToAction actionTitle={signInTitle} onAction={this.signInDotCom}>
            <div>
              {this.props.t('publishRepository.signInToYourGithubComAccount')}
            </div>
          </CallToAction>
        )
      case PublishTab.Enterprise:
        return (
          ...
          >
            <div>
              {this.props.t('publishRepository.signInToEnterpriseAtWork')}
            </div>
          </CallToAction>
        )
      default:
...
export const Publish = withTranslation()(
  PublishInternal
) as unknown as React.ComponentClass<IPublishProps>
