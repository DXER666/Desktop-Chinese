 ...
 */
export class RepositoryPathInternal extends React.Component<
  IRepositoryPathProps & WithTranslation,
  IRepositoryPathState
> {
  public constructor(props: IRepositoryPathProps & WithTranslation) {
    super(props)
    this.state = {
  ...
  private renderSanitizedName() {
    ...
    return (
      <InputWarning
        ...
        ariaLiveMessage={t(
          'repositoryPath.willBeCreatedAsAriaLive',
          'Will be created as {{sanitizedName}}. Invalid characters have been replaced by hyphens.',
          { sanitizedName }
        )}
      >
        <p>
          {t(
            'repositoryPath.willBeCreatedAs',
        ...
        <span className="sr-only">
          {t(
            'repositoryPath.invalidCharactersReplaced',
        ...
        <Row>
          <TextBox
            ...
            label={
              ...
              t('repositoryPath.nameLabelDefault', 'Name')
            }
            placeholder={
              this.props.namePlaceholder ??
              t('repositoryPath.namePlaceholderDefault', 'name')
            }
        ...
        <Row>
          <TextBox
            ...
            label={
              ...
              (__DARWIN__
                ? t('repositoryPath.localPathLabelDefaultDarwin', 'Local Path')
                : t('repositoryPath.localPathLabelDefaultOther', 'Local path'))
            }
            placeholder={
              this.props.pathPlaceholder ??
              t('repositoryPath.pathPlaceholderDefault', 'path')
            }
          ...
          <Button onClick={this.showFilePicker} disabled={loadingPath}>
            {t('repositoryPath.chooseButton', 'Choose…')}
          </Button>
        </Row>
      </>
    )
...
export function setRepositoryDefaultPath(path: string): void {
  setDefaultDir(path)
}

export const RepositoryPath = withTranslation()(
  RepositoryPathInternal
) as unknown as React.ComponentClass<IRepositoryPathProps>
