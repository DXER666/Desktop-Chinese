 ...
 */
export class ConfigureGitUserInternal extends React.Component<
  IConfigureGitUserProps & WithTranslation,
  ...
  private renderConfigForm() {
    return (
      <Form className="sign-in-form" onSubmit={this.save}>
        ...
        <Row>
          <Button type="submit">
            {this.props.saveLabel || this.props.t('common.save')}
          </Button>
          {this.props.children}
        </Row>
      </Form>
...
export const ConfigureGitUser = withTranslation()(ConfigureGitUserInternal)
