...
class AuthenticationFormInternal extends React.Component<
  IAuthenticationFormProps & WithTranslation
> {
  public render() {
    return (
  ...
  private renderEndpointRequiresWebFlow() {
    const { t } = this.props
    const redirectMessage = t(
      'signIn.browserInfoContent',
    ...
    const signInButtonLabel = __DARWIN__
      ? t('signIn.signInUsingBrowserDarwin', 'Sign in using your browser')
      : t('signIn.signInUsingBrowserOther', 'Sign in using your browser')
...
export const AuthenticationForm = withTranslation()(
  AuthenticationFormInternal
) as unknown as React.ComponentClass<IAuthenticationFormProps>
