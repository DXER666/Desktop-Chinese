...
class CopilotModelPickerInternal extends React.Component<
  ICopilotModelPickerProps & WithTranslation,
...
> {
  ...
  public constructor(props: ICopilotModelPickerProps & WithTranslation) {
    super(props)
  ...
  public componentDidUpdate(
    prevProps: ICopilotModelPickerProps & WithTranslation
  ) {
    if (
  ...
  private renderNoItems = () => {
    ...
    return (
      <div className="copilot-model-list-empty">
        {t('copilotModelPicker.noModelsFound', 'No models found.')}
      </div>
    )
  }
...
export const CopilotModelPicker = withTranslation()(
  CopilotModelPickerInternal
) as unknown as React.ComponentClass<ICopilotModelPickerProps>
