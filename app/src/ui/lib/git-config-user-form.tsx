...
class GitConfigUserFormInternal extends React.Component<
  IGitConfigUserFormProps & WithTranslation,
...
> {
  ...
  public constructor(props: IGitConfigUserFormProps & WithTranslation) {
    super(props)
  ...
  public componentDidUpdate(
    prevProps: IGitConfigUserFormProps & WithTranslation,
  ...
  public render() {
    ...
    return (
      <div>
        <Row>
          <TextBox
            label={t('gitConfigUserForm.nameLabel', 'Name')}
  ...
  private renderEmailDropdown() {
    ...
    const accountSuffix = (account: Account) =>
      isDotComAccount(account)
        ? t('gitConfigUserForm.accountSuffixDotCom', '(GitHub.com)')
        : t(
            'gitConfigUserForm.accountSuffixEnterprise',
            '(GitHub Enterprise)'
          )
    ...
    return (
      <Row>
        <Select
          label={t('gitConfigUserForm.emailLabel', 'Email')}
          value={
        ...
        >
          ...
          <option key={OtherEmailSelectValue} value={OtherEmailSelectValue}>
            {t('gitConfigUserForm.otherEmailOption', 'Other')}
          </option>
        </Select>
      </Row>
    )
  ...
  private renderEmailTextBox() {
    ...
    const labelKey = this.state.emailIsOther
      ? undefined
      : 'gitConfigUserForm.emailLabel'
    const label = labelKey ? t(labelKey, 'Email') : undefined
    // If there is not a label, provide a screen reader announcement.
    const ariaLabel = label
      ? undefined
      : t('gitConfigUserForm.emailLabel', 'Email')
 ...
 */
export const GitConfigUserForm = withTranslation()(
  GitConfigUserFormInternal
) as unknown as React.ComponentClass<IGitConfigUserFormProps>
