...
class SideBySideDiffRowInternal extends React.Component<
  ISideBySideDiffRowProps & WithTranslation,
  ISideBySideDiffRowState
> {
  public constructor(props: ISideBySideDiffRowProps & WithTranslation) {
    super(props)
        ...
        <div className="content-wrapper">
          ...
          {data.noNewLineIndicator && (
            <span className="no-newline-indicator">
              ...
              <span>
                {' '}
                {t('diff.noNewlineAtEndOfFile', 'No newline at end of file')}
              </span>
            </span>
          )}
        </div>
...
export const SideBySideDiffRow = withTranslation()(
  SideBySideDiffRowInternal
) as unknown as React.ComponentClass<ISideBySideDiffRowProps>
