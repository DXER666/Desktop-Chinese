...
class RepositorySettingsInternal extends React.Component<
  IRepositorySettingsProps & WithTranslation,
  IRepositorySettingsState
> {
  public constructor(props: IRepositorySettingsProps & WithTranslation) {
    super(props)
  ...
  public render() {
    ...
    const title = __DARWIN__
      ? t('repositorySettings.titleDarwin', 'Repository Settings')
      : t('repositorySettings.titleOther', 'Repository settings')
        ...
        <div className="tab-container">
          ...
          >
            <span>
              ...
              {t('repositorySettings.tabs.remote', 'Remote')}
            </span>
            <span>
              <Octicon className="icon" symbol={octicons.file} />
              {__DARWIN__
                ? t('repositorySettings.tabs.ignoredFilesDarwin', 'Ignored Files')
                : t('repositorySettings.tabs.ignoredFilesOther', 'Ignored files')}
            </span>
            <span>
              <Octicon className="icon" symbol={octicons.gitCommit} />
              {__DARWIN__
                ? t('repositorySettings.tabs.gitConfigDarwin', 'Git Config')
                : t('repositorySettings.tabs.gitConfigOther', 'Git config')}
            </span>
            {showForkSettings && (
              <span>
                <Octicon className="icon" symbol={octicons.repoForked} />
                {__DARWIN__
                  ? t('repositorySettings.tabs.forkBehaviorDarwin', 'Fork Behavior')
                  : t('repositorySettings.tabs.forkBehaviorOther', 'Fork behavior')}
              </span>
            )}
          </TabBar>
...
export const RepositorySettings = withTranslation()(
  RepositorySettingsInternal
) as unknown as React.ComponentClass<IRepositorySettingsProps>
