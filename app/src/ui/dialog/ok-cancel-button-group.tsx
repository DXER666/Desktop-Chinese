 ...
 */
export class OkCancelButtonGroupInternal extends React.Component<
  IOkCancelButtonGroupProps & WithTranslation,
  {}
> {
  ...
  private renderOkButton() {
    ...
    return (
      ...
      >
        {this.props.okButtonText || t('common.ok')}
      </Button>
    )
  }
  ...
  private renderCancelButton() {
    ...
    return (
      ...
      >
        {this.props.cancelButtonText || t('common.cancel')}
      </Button>
    )
  }
...
export const OkCancelButtonGroup = withTranslation()(OkCancelButtonGroupInternal)
