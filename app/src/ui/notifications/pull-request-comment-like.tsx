 ...
 */
class PullRequestCommentLikeInternal extends React.Component<
  IPullRequestCommentLikeProps & WithTranslation
> {
  public render() {
  ...
  private renderReviewBody() {
    const { t, body, emoji, pullRequest } = this.props
    ...
    return (
      <SandboxedMarkdown
        ...
        ariaLabel={t(
          'notifications.pullRequestMarkdownComment',
          'Pull request markdown comment'
        )}
      />
    )
  }
...
export const PullRequestCommentLike = withTranslation()(
  PullRequestCommentLikeInternal
) as unknown as React.ComponentClass<IPullRequestCommentLikeProps>
