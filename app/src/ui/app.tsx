...
import { RepositoryView, RepositoryViewInternal } from './repository'
...
> {
  ...
  private repositoryViewRef = React.createRef<RepositoryViewInternal>()
  ...
  public constructor(props: any) {
    ...
    props.appStore.onDidUpdate((state: IAppState) => {
      this.setState(state)
    })

    props.appStore.onDidError((error: Error) => {
  ...
  private renderRepositoryToolbarButton() {
    ...
    return (
      <ToolbarDropdown
        ...
        description={
          __DARWIN__
            ? this.props.t('toolbar.currentRepositoryDarwin')
            : this.props.t('toolbar.currentRepositoryOther')
        }
        tooltip={tooltip}
...
export const AppWrapper = withTranslation()(
  App
) as unknown as React.ComponentClass<IAppProps>
