...
class RepositoriesListInternal extends React.Component<
  IRepositoriesListProps & WithTranslation,
...
> {
  ...
  public constructor(props: IRepositoriesListProps & WithTranslation) {
    super(props)
  ...
  private getGroupLabel(group: RepositoryListGroup) {
    ...
    if (kind === 'enterprise') {
      ...
      return t('repositoriesList.groupLabelOther', 'Other')
    } else if (kind === 'dotcom') {
      return group.owner.login
    } else if (kind === 'recent') {
      return t('repositoriesList.groupLabelRecent', 'Recent')
    } else {
  ...
  private onNewRepositoryButtonClick = () => {
    ...
    const items: IMenuItem[] = [
      {
        label: __DARWIN__
          ? t('repositoriesList.cloneRepositoryDarwin', 'Clone Repository…')
          : t('repositoriesList.cloneRepositoryOther', 'Clone repository…'),
        action: this.onCloneRepository,
      },
      {
        label: __DARWIN__
          ? t(
              'repositoriesList.createNewRepositoryDarwin',
              'Create New Repository…'
            )
          : t(
              'repositoriesList.createNewRepositoryOther',
              'Create new repository…'
            ),
      ...
      },
      {
        label: __DARWIN__
          ? t(
              'repositoriesList.addExistingRepositoryDarwin',
              'Add Existing Repository…'
            )
          : t(
              'repositoriesList.addExistingRepositoryOther',
              'Add existing repository…'
            ),
...
export const RepositoriesList = withTranslation()(
  RepositoriesListInternal
) as unknown as React.ComponentClass<IRepositoriesListProps>
