...
class ThankYouInternal extends React.Component<
  IThankYouProps & WithTranslation,
  IThankYouState
> {
  public constructor(props: IThankYouProps & WithTranslation) {
    super(props)
    this.state = {}
  }
  private renderList(
  ...
  public render() {
    ...
    const thankYouNote = (
      <>
        {t(
          'thankYou.note',
          "Thanks so much for all your hard work on GitHub Desktop{{version}}. We're so grateful for your willingness to contribute and make the app better for everyone!",
          { version }
        )}
      </>
    )
    ...
    return (
      <Dialog
        ...
        title={t('thankYou.title', 'Thank you {{friendlyName}}! 🎉', {
        ...
        <DialogContent>
          <div className="container">
            ...
            <div className="contributions-heading">
              {t('thankYou.contributedHeading', 'You contributed:')}
            </div>
...
export const ThankYou = withTranslation()(
  ThankYouInternal
) as unknown as React.ComponentClass<IThankYouProps>
