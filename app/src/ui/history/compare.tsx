...
import { CommitList, CommitListClass } from './commit-list'
import { Repository } from '../../models/repository'
import { Branch } from '../../models/branch'
import { defaultErrorHandler, Dispatcher } from '../dispatcher'
import { ThrottledScheduler } from '../lib/throttled-scheduler'
import { BranchList, BranchListClass } from '../branches'
...
> {
  ...
  private branchList: BranchListClass | null = null
  private commitListRef = React.createRef<CommitListClass>()
  ...
  private onBranchesListRef = (branchList: BranchListClass | null) => {
