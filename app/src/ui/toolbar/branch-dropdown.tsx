 ...
 */
export class BranchDropdownInternal extends React.Component<
  IBranchDropdownProps & WithTranslation
> {
  ...
  public render() {
    ...
    let description = __DARWIN__
      ? this.props.t('toolbar.currentBranchDarwin')
      : this.props.t('toolbar.currentBranchOther')
    let canOpen = true
    let disabled = false
    let tooltip: string
    ...
    if (tip.kind === TipState.Unknown) {
      ...
      title = tip.ref
      tooltip = this.props.t('toolbar.currentBranchIsRef', { ref: tip.ref })
    ...
    return (
      <>
        <Resizable
          ...
          description={this.props.t('toolbar.currentBranchDropdown')}
        >
          <ToolbarDropdown
            className="branch-button"
            icon={icon}
...
export const BranchDropdown = withTranslation()(
  BranchDropdownInternal
) as unknown as React.ComponentClass<IBranchDropdownProps>
