 ...
 * repository.
 */
export class PushPullButtonInternal extends React.Component<
  IPushPullButtonProps & WithTranslation,
...
> {
  ...
  private progressButton(progress: Progress, networkActionInProgress: boolean) {
    return (
      <ToolbarButton
        ...
        description={progress.description || this.props.t('toolbar.hangOn')}
  ...
  private publishRepositoryButton(onClick: () => void) {
    return (
      <ToolbarButton
        {...this.defaultButtonProps()}
        title={this.props.t('toolbar.publishRepositoryTitle')}
        description={this.props.t('toolbar.publishRepositoryDescription')}
        className="push-pull-button"
  ...
  private detachedHeadButton(rebaseInProgress: boolean) {
    ...
    const description = rebaseInProgress
      ? t('toolbar.rebaseInProgressDescription')
      : t('toolbar.cannotPublishDetachedHeadDescription')

    return (
      <ToolbarButton
        {...this.defaultButtonProps()}
        title={t('toolbar.publishBranchTitle')}
  ...
  private publishBranchButton(
    ...
    const description = isGitHub
      ? t('toolbar.publishBranchToGitHubDescription')
      : t('toolbar.publishBranchToRemoteDescription')
  ...
  private fetchButton(
    ...
    const { t } = this.props
    const title = t('toolbar.fetchTitle', { remoteName })
    return (
      <ToolbarButton
        {...this.defaultButtonProps()}
        title={title}
        description={renderLastFetched(lastFetched, t)}
        icon={syncClockwise}
        onClick={onClick}
      />
    )
  ...
  private pullButton(
    ...
    const title = pullWithRebase
      ? t('toolbar.pullWithRebaseTitle', { remoteName })
      : t('toolbar.pullTitle', { remoteName })
  ...
  private pushButton(
    ...
    return (
      <ToolbarDropdown
        {...this.defaultDropdownProps()}
        title={t('toolbar.pushTitle', { remoteName })}
        description={renderLastFetched(lastFetched, t)}
  ...
  private forcePushButton(
    ...
    return (
      <ToolbarDropdown
        {...this.defaultDropdownProps()}
        title={t('toolbar.forcePushTitle', { remoteName })}
        description={renderLastFetched(lastFetched, t)}
        icon={forcePushIcon}
        onClick={onClick}
        dropdownContentRenderer={this.getDropdownContentRenderer([
...
export const PushPullButton = withTranslation()(
  PushPullButtonInternal
) as unknown as React.ComponentClass<IPushPullButtonProps>
