...
class WorktreeDropdownInternal extends React.Component<
  IWorktreeDropdownProps & WithTranslation,
  IWorktreeDropdownState
> {
  public constructor(props: IWorktreeDropdownProps & WithTranslation) {
    super(props)
    this.state = {
      filterText: '',
    }
  ...
  public render() {
    const { t, isOpen, enableFocusTrap } = this.props
    ...
    const description = __DARWIN__
      ? t('worktree.currentWorktreeDarwin', 'Current Worktree')
      : t('worktree.currentWorktree', 'Current worktree')
      ...
      <ToolbarDropdown
        ...
        tooltip={
          isOpen
            ? undefined
            : t(
                'worktree.currentWorktreeIsTitle',
                'Current worktree is {{title}}',
                {
                  title,
                }
              )
    ...
    return (
      <Resizable
        ...
        description={t(
          'worktree.dropdownButtonDescription',
...
export const WorktreeDropdown = withTranslation()(
  WorktreeDropdownInternal
) as unknown as React.ComponentClass<IWorktreeDropdownProps>
