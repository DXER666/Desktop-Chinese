 ...
 */
export class EditCopilotBYOKModelDialogInternal extends React.Component<
  IEditCopilotBYOKModelDialogProps & WithTranslation,
...
export const EditCopilotBYOKModelDialog = withTranslation()(
  EditCopilotBYOKModelDialogInternal
)
