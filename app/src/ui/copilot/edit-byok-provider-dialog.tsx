...
export class EditCopilotBYOKProviderDialogInternal extends React.Component<
  IEditCopilotBYOKProviderDialogProps & WithTranslation,
  ...
  public render() {
    ...
    return (
      ...
      >
        ...
        <DialogFooter>
          <OkCancelButtonGroup
            okButtonText={isEditing ? t('common.save') : t('common.create')}
          />
        </DialogFooter>
      </Dialog>
    )
...
export const EditCopilotBYOKProviderDialog = withTranslation()(
  EditCopilotBYOKProviderDialogInternal
)
