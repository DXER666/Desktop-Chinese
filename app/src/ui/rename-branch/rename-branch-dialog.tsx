...
class RenameBranchInternal extends React.Component<
  IRenameBranchProps & WithTranslation,
  IRenameBranchState
> {
  ...
  public constructor(props: IRenameBranchProps & WithTranslation) {
    super(props)
  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={
          __DARWIN__
            ? t('renameBranch.titleDarwin', 'Rename Branch')
            : t('renameBranch.titleOther', 'Rename branch')
        }
      ...
      >
        <DialogContent>
          {renderBranchHasRemoteWarning(this.props.branch, t)}
          <RefNameTextBox
            label={t('renameBranch.nameLabel', 'Name')}
...
export const RenameBranch = withTranslation()(
  RenameBranchInternal
) as unknown as React.ComponentClass<IRenameBranchProps>
