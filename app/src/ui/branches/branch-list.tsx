...
class BranchListImpl extends React.Component<
  IBranchListProps & WithTranslation,
  IBranchListState
> {
  ...
  public constructor(props: IBranchListProps & WithTranslation) {
    super(props)
    this.state = {
  ...
  public componentDidUpdate(prevProps: IBranchListProps & WithTranslation) {
  ...
  private getGroupLabel(identifier: BranchGroupIdentifier) {
    ...
    if (identifier === 'default') {
      return t('branches.defaultBranch')
    } else if (identifier === 'recent') {
      return t('branches.recentBranches')
    } else if (identifier === 'other') {
      return t('branches.otherBranches')
    } else {
  ...
  private onRenderNewButton = () => {
    return this.props.canCreateNewBranch ? (
      <Button className="new-branch-button" onClick={this.onCreateNewBranch}>
        {this.props.t('branches.newBranch')}
      </Button>
    ) : null
  }
...
export type BranchListClass = BranchListImpl
export const BranchList = withTranslation()(
  BranchListImpl
) as unknown as React.ComponentClass<IBranchListProps>
