...
class PullRequestListImpl extends React.Component<
  IPullRequestListProps & WithTranslation,
  IPullRequestListState
> {
  public constructor(props: IPullRequestListProps & WithTranslation) {
    super(props)
  ...
  public componentWillReceiveProps(nextProps: IPullRequestListProps & WithTranslation) {
    ...
    const screenReaderStateMessage = loadingStarted
      ...
      : loadingComplete
      ? t('pullRequestEmptyState.issueCount_one_other', {
  ...
  private getListAriaLabel = () => {
    const { t } = this.props
    return t('branches.pullRequestsGroupHeader', {
    ...
    return (
      <>
        <SectionFilterList<IPullRequestListItem>
          ...
          placeholderText={this.props.t('branches.filter')}
  ...
  private renderListHeader = () => {
    ...
    return (
      <div className="filter-list-group-header">
        {t('branches.pullRequestsGroupHeader', {
          repo: this.getRepositoryName(),
        })}
      </div>
    )
  ...
  private renderPostFilter = () => {
    const { t } = this.props
    const tooltip = t('branches.refreshPullRequestsTooltip')
...
export type PullRequestListClass = PullRequestListImpl
export const PullRequestList = withTranslation()(
  PullRequestListImpl
) as unknown as React.ComponentClass<IPullRequestListProps>
