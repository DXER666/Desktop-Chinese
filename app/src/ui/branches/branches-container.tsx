...
class BranchesContainerImpl extends React.Component<
  IBranchesContainerProps & WithTranslation,
  IBranchesContainerState
> {
  public static getDerivedStateFromProps(
    props: any,
    state: IBranchesContainerState
  ...
  public constructor(props: IBranchesContainerProps & WithTranslation) {
    super(props)
    ...
    return (
      <Row className="merge-button-row">
        <Button
          ...
          tooltip={t('branches.chooseToMergeTooltip', {
            branchName: currentBranch.name,
          })}
        >
          <Octicon className="icon" symbol={octicons.gitMerge} />
          {t('branches.chooseToMergeButtonPrefix')}
  ...
  private renderTabBar() {
    ...
    return (
      ...
      >
        <span id="branches-tab">{t('branches.branchesTab')}</span>
        <span id="pull-requests-tab" className="pull-request-tab">
          {t('branches.pullRequestsTab')}
  ...
  private renderPreList = () => {
    ...
    const label = this.props.t('branches.newBranch')
...
export type BranchesContainerClass = BranchesContainerImpl
export const BranchesContainer = withTranslation()(
  BranchesContainerImpl
) as unknown as React.ComponentClass<IBranchesContainerProps>
