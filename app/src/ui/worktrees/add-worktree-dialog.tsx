...
export class AddWorktreeDialogInternal extends React.Component<
  IAddWorktreeDialogProps & WithTranslation,
...
> {
  ...
  public constructor(props: IAddWorktreeDialogProps & WithTranslation) {
    super(props)
      ...
      <Row>
        <p className="branch-status-hint">
          {branch.type === BranchType.Remote ? (
            <>
              {t(
                'addWorktree.willCheckoutRemoteBranchPrefix',
            ...
            <>
              {t(
                'addWorktree.willCheckoutExistingBranchPrefix',
  ...
  private renderPathMessage() {
    ...
    return (
      <div id="add-worktree-path-msg">
        {t('addWorktree.worktreeWillBeCreatedAtPrefix', 'Worktree will be created at ')}{' '}
        <Ref>{fullPath}</Ref>.
      </div>
    )
  }
  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={
          __DARWIN__
            ? t('addWorktree.titleDarwin', 'Add Worktree')
            : t('addWorktree.titleOther', 'Add worktree')
        }
      ...
      >
        <DialogContent>
          <RepositoryPath
            ...
            nameLabel={
              __DARWIN__
                ? t('addWorktree.worktreeNameLabelDarwin', 'Worktree Name')
                : t('addWorktree.worktreeNameLabelOther', 'Worktree name')
            }
            namePlaceholder={t(
              'addWorktree.worktreeNamePlaceholder',
              'worktree name'
            )}
            pathPlaceholder={t(
              'addWorktree.worktreePathPlaceholder',
              'worktree path'
            )}
          />
          ...
          <Row>
            <RefNameTextBox
              label={
                __DARWIN__
                  ? t('addWorktree.branchNameLabelDarwin', 'Branch Name')
                  : t('addWorktree.branchNameLabelOther', 'Branch name')
              }
        ...
        <DialogFooter>
          ...
          <OkCancelButtonGroup
            okButtonText={
              __DARWIN__
                ? t('addWorktree.createWorktreeButtonDarwin', 'Create Worktree')
                : t('addWorktree.createWorktreeButtonOther', 'Create worktree')
            }
...
export const AddWorktreeDialog = withTranslation()(
  AddWorktreeDialogInternal
) as unknown as React.ComponentClass<IAddWorktreeDialogProps>
