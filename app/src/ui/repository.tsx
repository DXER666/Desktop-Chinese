...
export class RepositoryViewInternal extends React.Component<
  IRepositoryViewProps & WithTranslation,
    ...
    return (
      <TabBar selectedIndex={selectedTab} onTabClicked={this.onTabClicked}>
        <span className="with-indicator" id="changes-tab">
          <span>{this.props.t('repositoryTabs.changes')}</span>
          {this.renderChangesBadge()}
        </span>

        <div className="with-indicator" id="history-tab">
          <span>{this.props.t('repositoryTabs.history')}</span>
        </div>
      </TabBar>
    )
  }
...
export const RepositoryView = withTranslation()(
  RepositoryViewInternal
) as unknown as React.ComponentClass<IRepositoryViewProps>
