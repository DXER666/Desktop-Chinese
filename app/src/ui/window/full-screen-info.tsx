 ...
 */
class FullScreenInfoInternal extends React.Component<
  IFullScreenInfoProps & WithTranslation,
...
> {
  ...
  public constructor(props: IFullScreenInfoProps & WithTranslation) {
    super(props)
  ...
  public componentDidUpdate(
    prevProps: IFullScreenInfoProps & WithTranslation,
      ...
      >
        <div key="notification" className="toast-notification">
          <Trans
            i18nKey={
              __DARWIN__
                ? 'fullscreen.exitFullscreenPromptDarwin'
                : 'fullscreen.exitFullscreenPromptOther'
            }
            defaults={__DARWIN__
              ? 'Press <shortcut></shortcut> to exit fullscreen'
              : 'Press <shortcut></shortcut> to exit fullscreen'}
            components={{ shortcut: shortcutNode }}
          />
        </div>
      </CSSTransition>
    )
...
export const FullScreenInfo = withTranslation()(
  FullScreenInfoInternal
) as unknown as React.ComponentClass<IFullScreenInfoProps>
