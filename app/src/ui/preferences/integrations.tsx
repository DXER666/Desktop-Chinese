...
export class IntegrationsInternal extends React.Component<
  IIntegrationsPreferencesProps & WithTranslation,
...
> {
  ...
  private renderExternalEditor() {
    ...
    const label = __DARWIN__
      ? t('preferences.integrations.externalEditorDarwin')
      : t('preferences.integrations.externalEditorOther')
        ...
        <div className="select-component no-options-found">
          ...
          <span>
            ...
            <LinkButton uri={suggestedExternalEditor.url}>
              {t('preferences.integrations.installExternalEditorName')}{' '}
    ...
    return (
      <Select
        ...
        aria-label={t('preferences.integrations.externalEditorOther')}
        value={
          useCustomEditor
      ...
      >
        ...
        {enableCustomIntegration() && (
          <option key={CustomIntegrationValue} value={CustomIntegrationValue}>
            {__DARWIN__
              ? t('preferences.integrations.configureCustomEditorDarwin')
              : t('preferences.integrations.configureCustomEditorOther')}
          </option>
        )}
      </Select>
    )
    ...
    return (
      ...
      >
        ...
        {enableCustomIntegration() && (
          <option key={CustomIntegrationValue} value={CustomIntegrationValue}>
            {__DARWIN__
              ? t('preferences.integrations.configureCustomShellDarwin')
              : t('preferences.integrations.configureCustomShellOther')}
          </option>
        )}
      </Select>
    )
...
export const Integrations = withTranslation()(IntegrationsInternal)
