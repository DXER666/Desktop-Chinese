...
class PreferencesInternal extends React.Component<
  IPreferencesProps & WithTranslation,
  IPreferencesState
> {
  public constructor(props: IPreferencesProps & WithTranslation) {
    super(props)
  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={
          __DARWIN__
            ? t('preferences.dialogTitleMac')
            : t('preferences.dialogTitleOther')
        }
...
export const Preferences = withTranslation()(PreferencesInternal) as React.ComponentClass<IPreferencesProps>
