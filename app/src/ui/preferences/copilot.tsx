...
class CopilotPreferencesInternal extends React.Component<
  ICopilotPreferencesProps & WithTranslation
> {
  public render() {
  ...
  private renderAccessState(accessState: CopilotAccessState): JSX.Element {
    ...
    switch (accessState) {
      ...
      case 'checking':
        return (
          <p>
            {t('preferencesCopilot.checkingAccess', 'Checking Copilot access…')}
          </p>
        )
      case 'no-license':
        return this.renderAccessCallToAction(
          t(
            'preferencesCopilot.noLicenseMessage',
            'Copilot features in GitHub Desktop require a GitHub Copilot license.'
          ),
          t('preferencesCopilot.viewPlans', 'View Copilot plans'),
          this.props.onOpenCopilotPlans
        )
      case 'desktop-disabled':
        return this.renderAccessCallToAction(
          t(
            'preferencesCopilot.desktopDisabledMessage',
          ...
          t(
            'preferencesCopilot.openFeatureSettings',
...
export const CopilotPreferences = withTranslation()(
  CopilotPreferencesInternal
) as unknown as React.ComponentClass<ICopilotPreferencesProps>
